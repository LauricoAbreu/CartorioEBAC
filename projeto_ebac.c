...
int registro() //funcao responsavel por cadastrar os usucarios no sistema
{
	...
	strcpy(arquivo, cpf); //responsavel por cpiar os valores dos strings
...

{
	...
	for(laco=1;laco=1;)
    {
	   ...
	   switch(opcao) //inico da selecao do menu
	   {
	   	  case 1:
